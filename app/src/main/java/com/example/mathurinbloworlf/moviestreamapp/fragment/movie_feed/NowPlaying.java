...
import com.example.mathurinbloworlf.moviestreamapp.activity.MovieInfo;
...
public class NowPlaying extends Fragment{
    ...
    */
    ...
    //String url = "https://api.themoviedb.org/3/movie/now_playing?page=1&language=en-US&?api_key="+ MovieDB.key;
    //String url = "https://api.themoviedb.org/3/movie/now_playing?api_key="+ MovieDB.key;
    private int page = 1;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        /*
        listView = view.findViewById(R.id.now_playing_listview);
        ...
        */
        ...
        swipeRefreshLayout = view.findViewById(R.id.now_playing_refresh);
        ...
        recyclerView.addOnItemTouchListener(new CustomMovieAdapter.RecyclerTouchListener(getContext(),
                recyclerView,
                new CustomMovieAdapter.ClickListener() {
            @Override
            public void onClick(View view, int position) {
                //Intent intent = new Intent(getContext(), MovieInfo.class);
                //String id = recyclerView.indexOfChild(view)
                //intent.putExtra("id",);
    ...
    private void loadNowPlaying(final int page) {
        @SuppressLint("StaticFieldLeak") AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            @Override
            protected Void doInBackground(Integer... integers) {
                OkHttpClient client = new OkHttpClient();
                Request request = new Request.Builder()
                        .url("https://api.themoviedb.org/3/movie/now_playing?api_key="+ MovieDB.key +"&page=" + page)
                        .build();
